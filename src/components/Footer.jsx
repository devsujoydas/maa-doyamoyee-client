          ...
          <div className="lg:w-1/3">
            ...
            <div className="space-y-2 text-sm">
              <p className="flex items-center gap-2">
                <IoCall className="text-yellow-600 " /> {t("footer_contact_phone")}
              </p>
              <p className="flex items-center gap-2">
                <MdOutlineAlternateEmail className="text-yellow-600 " /> {t("footer_contact_email")}
              </p>
              <p className="flex items-center gap-2">
                <IoLocationSharp className="text-yellow-600 " />  {t("footer_contact_address")}
              </p>
            </div>
          </div>
