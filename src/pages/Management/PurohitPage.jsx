            ...
            >
              ...
              <div className="flex-1 space-y-4 text-center sm:text-left">
                <div>
                  ...
                  <p className="text-yellow-600">{pandit.designation}</p>
                </div>

                <div className="text-sm space-y-2">
                  <p>
                    <b>{t("purohit.experience")}:</b> {pandit.experience}
                  </p>
                  <p>
                    <b>{t("purohit.speciality")}:</b> {pandit.speciality}
                  </p>
                  <p>
                    <b>{t("purohit.availability")}:</b> {pandit.availableDays}
                  </p>
